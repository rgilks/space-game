...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__21584_SHARP_){
return ((p1__21584_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__21584_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__21586,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__21586;
}
});
...
var len__21393__auto___21589 = arguments.length;
var i__21394__auto___21590 = (0);
while(true){
if((i__21394__auto___21590 < len__21393__auto___21589)){
args__21400__auto__.push((arguments[i__21394__auto___21590]));

var G__21591 = (i__21394__auto___21590 + (1));
i__21394__auto___21590 = G__21591;
continue;
} else {
}
break;
...
var G__21588 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21588,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__21588;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq21587){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21587));
});
...
var tag_name = cljs.core.nth.call(null,vec__21597,(0),null);
var names = cljs.core.nth.call(null,vec__21597,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__21597,tag_name,names){
return (function (p1__21592_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21592_SHARP_));
});})(matches,vec__21597,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__21597,tag_name,names){
return (function (p1__21593_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21593_SHARP_));
});})(matches,vec__21597,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__21600){
var vec__21607 = p__21600;
var seq__21608 = cljs.core.seq.call(null,vec__21607);
var first__21609 = cljs.core.first.call(null,seq__21608);
var seq__21608__$1 = cljs.core.next.call(null,seq__21608);
var tag = first__21609;
var content = seq__21608__$1;
...
var vec__21610 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21610,(0),null);
var id = cljs.core.nth.call(null,vec__21610,(1),null);
var class$ = cljs.core.nth.call(null,vec__21610,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1488085468174