...
var len__21393__auto___21570 = arguments.length;
var i__21394__auto___21571 = (0);
while(true){
if((i__21394__auto___21571 < len__21393__auto___21570)){
args__21400__auto__.push((arguments[i__21394__auto___21571]));

var G__21572 = (i__21394__auto___21571 + (1));
i__21394__auto___21571 = G__21572;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq21569){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21569));
});
...
var vec__21576 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__21577 = cljs.core.seq.call(null,vec__21576);
var first__21578 = cljs.core.first.call(null,seq__21577);
var seq__21577__$1 = cljs.core.next.call(null,seq__21577);
var first_word = first__21578;
var words = seq__21577__$1;
...
var G__21580 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__21580,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono.util.camel_case_keys);
} else {
return G__21580;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__21581_SHARP_){
if(typeof p1__21581_SHARP_ === 'string'){
return p1__21581_SHARP_;
} else {
return cljs.core.seq.call(null,p1__21581_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1488085468114