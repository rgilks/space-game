...
var vec__26518 = axis;
var a_x = cljs.core.nth.call(null,vec__26518,(0),null);
var a_y = cljs.core.nth.call(null,vec__26518,(1),null);
var a_z = cljs.core.nth.call(null,vec__26518,(2),null);
var vec__26521 = v;
var x = cljs.core.nth.call(null,vec__26521,(0),null);
var y = cljs.core.nth.call(null,vec__26521,(1),null);
var z = cljs.core.nth.call(null,vec__26521,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__26524,p__26525){
var vec__26532 = p__26524;
var u1 = cljs.core.nth.call(null,vec__26532,(0),null);
var u2 = cljs.core.nth.call(null,vec__26532,(1),null);
var u3 = cljs.core.nth.call(null,vec__26532,(2),null);
var vec__26535 = p__26525;
var v1 = cljs.core.nth.call(null,vec__26535,(0),null);
var v2 = cljs.core.nth.call(null,vec__26535,(1),null);
var v3 = cljs.core.nth.call(null,vec__26535,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__26538_SHARP_){
return (p1__26538_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__26539_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__26540_SHARP_,angle_lr),angle_ud);
...
var map__26547 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__26547__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__26547__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__26549 = cljs.core._EQ_;
var expr__26550 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__26549.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__26550))){
return straight;
} else {
if(cljs.core.truth_(pred__26549.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__26550))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__26549.call(null,quil.middlewares.navigation_3d.space,expr__26550))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__26549.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__26550))){
return up;
} else {
if(cljs.core.truth_(pred__26549.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__26550))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__26549.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__26550))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__26547,map__26547__$1,up,straight){
return (function (p1__26541_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__26541_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__26547,map__26547__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__26552_SHARP_);
});})(initial_state))
);
});
/**
...
var map__26564_26575 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__26564_26576__$1 = ((((!((map__26564_26575 == null)))?((((map__26564_26575.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26564_26575.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26564_26575):map__26564_26575);
var vec__26565_26577 = cljs.core.get.call(null,map__26564_26576__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_26578 = cljs.core.nth.call(null,vec__26565_26577,(0),null);
var c_y_26579 = cljs.core.nth.call(null,vec__26565_26577,(1),null);
var c_z_26580 = cljs.core.nth.call(null,vec__26565_26577,(2),null);
var vec__26568_26581 = cljs.core.get.call(null,map__26564_26576__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_26582 = cljs.core.nth.call(null,vec__26568_26581,(0),null);
var u_y_26583 = cljs.core.nth.call(null,vec__26568_26581,(1),null);
var u_z_26584 = cljs.core.nth.call(null,vec__26568_26581,(2),null);
var vec__26571_26585 = cljs.core.get.call(null,map__26564_26576__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_26586 = cljs.core.nth.call(null,vec__26571_26585,(0),null);
var p_y_26587 = cljs.core.nth.call(null,vec__26571_26585,(1),null);
var p_z_26588 = cljs.core.nth.call(null,vec__26571_26585,(2),null);
quil.core.camera.call(null,p_x_26586,p_y_26587,p_z_26588,(p_x_26586 + c_x_26578),(p_y_26587 + c_y_26579),(p_z_26588 + c_z_26580),u_x_26582,u_y_26583,u_z_26584);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1488147689663